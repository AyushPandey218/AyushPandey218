...
ROWS = [
    ("host",),
    ("kv", "Now", "Front-end AI Eng Intern @ FlyRank AI"),
    ("kv", "Edu", "BCA '26 + MCA AI & ML (Pursuing) @ KRMU"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "Languages", "TypeScript, Python, C++, Java, Rust"),
    ("kv", "Frontend", "React, Next.js, Tailwind CSS"),
    ("kv", "Backend/DB", "Node.js, FastAPI, MongoDB, SQL"),
    ("kv", "Cloud/Tools", "Git, Firebase, Vercel"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "Built FlowDeck (Android PC controller in Rust/Kotlin)"),
    ("bul", "Built Swift Speak (Local Whisper AI dictation in Rust)"),
    ("bul", "Built CodeQuest (Gamified coding platform)"),
]
...
parts.append(f'<text x="{W/2}" y="{TITLEBAR_H/2 + 4}" fill="{MUTED}" font-size="12" '
             f'text-anchor="middle">ayush@github: ~$ neofetch</text>')
